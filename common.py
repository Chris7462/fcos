...
class DetectorBackboneWithFPN(nn.Module):
    ...
    def forward(self, images: torch.Tensor):
        ...
        p4 = self.fpn_params['lateral_c4'](c4) + F.interpolate(p5, scale_factor=2, mode='nearest')
        p3 = self.fpn_params['lateral_c3'](c3) + F.interpolate(p4, scale_factor=2, mode='nearest')
